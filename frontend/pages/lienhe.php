    ...
    <main role="main" class="mb-2">
        ...
        if (isset($_POST['btnGoiLoiNhan'])) {
            ...
            try {
                ...
                $mail->Username = 'ttquynhd20051@cusc.ctu.edu.vn'; // SMTP username
                $mail->Password = 'rpbsmpehiltfeoxc';                   // SMTP password
                ...
                //Recipients
                $mail->setFrom('ttquynhd20051@cusc.ctu.edu.vn', 'Mail Liên hệ');
                $mail->addAddress('ttquynhd20051@cusc.ctu.edu.vn');               // Add a recipient
